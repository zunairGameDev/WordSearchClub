...
namespace FunGames.Mediation
{
    public class FGMediationCallbacks : FGModuleCallbacks
    {
        ...
        internal Action<string> _ShowBanner;
        internal Action<string, string> _ShowSpecificBanner;
        ...
        internal Action<Action<bool>, string> _ShowInter;
        internal Action<Action<bool>, string, string> _ShowSpecificInter;
        ...
        internal Action<Action<bool>, string> _ShowAppOpen;
        internal Action<Action<bool>, string, string> _ShowSpecificAppOpen;
        ...
        internal Action<Action<bool>, string> _ShowMrec;
        internal Action<Action<bool>, string, string> _ShowSpecificMrec;
        internal Action _HideMrec;
        internal Action<FGAdInfo> _OnMrecAdLoaded;
        internal Action<FGAdInfo> _OnMrecAdClicked;
        internal Action<string, FGAdInfo> _OnMrecAdImpression;
        internal Action _OnMrecAdFailedToLoad;
        internal Action<FGAdInfo> _OnMrecAdDisplayed;
        internal Action<FGAdInfo> _OnMrecAdClosed;
        ...
        public event Action<string> ShowBanner
        {
            add => _ShowBanner += value;
            remove => _ShowBanner -= value;
        }

        public event Action<string, string> ShowSpecificBanner
        {
        ...
        public event Action<Action<bool>, string> ShowInterstitial
        {
            add => _ShowInter += value;
            remove => _ShowInter -= value;
        }

        public event Action<Action<bool>, string, string> ShowSpecificInterstitial
        {
        ...
        public event Action<Action<bool>, string> ShowAppOpen
        {
            add => _ShowAppOpen += value;
            remove => _ShowAppOpen -= value;
        }
        
        public event Action<Action<bool>, string, string> ShowSpecificAppOpen
        {
            add => _ShowSpecificAppOpen += value;
            remove => _ShowSpecificAppOpen -= value;
        }
        ...
        public event Action<Action<bool>, string> ShowMrec
        {
            add => _ShowMrec += value;
            remove => _ShowMrec -= value;
        }

        public event Action<Action<bool>, string, string> ShowSpecificMrec
        {
            add => _ShowSpecificMrec += value;
            remove => _ShowSpecificMrec -= value;
        }

        public event Action HideMrec
        {
            add => _HideMrec += value;
            remove => _HideMrec -= value;
        }

        public event Action<FGAdInfo> OnMrecAdLoaded
        {
            add => _OnMrecAdLoaded += value;
            remove => _OnMrecAdLoaded -= value;
        }

        public event Action<FGAdInfo> OnMrecAdClicked
        {
            add => _OnMrecAdClicked += value;
            remove => _OnMrecAdClicked -= value;
        }
        ...
        public event Action OnMrecAdFailedToLoad
        {
            add => _OnMrecAdFailedToLoad += value;
            remove => _OnMrecAdFailedToLoad -= value;
        }

        public event Action<FGAdInfo> OnMrecAdClosed
        {
            add => _OnMrecAdClosed += value;
            remove => _OnMrecAdClosed -= value;
        }

        public event Action<FGAdInfo> OnMrecAdDisplayed
        {
            add => _OnMrecAdDisplayed += value;
            remove => _OnMrecAdDisplayed -= value;
        }
