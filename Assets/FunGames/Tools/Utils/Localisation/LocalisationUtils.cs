...
namespace FunGames.Tools.Utils
{
    public static class LocalisationUtils
    {
        ...
        public static bool isEEA(Location location)
        {
            bool isApplied = false;
            List<string> _eeaCountryCodes = new List<string>()
            {
            ...
            _eeaCountryCodes.AddRange(_countryCodesGdpr);
            isApplied = _eeaCountryCodes.Contains(location.countryCode);
            return isApplied;
        }
