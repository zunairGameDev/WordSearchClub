...
{
    public class FGRemoteConfigManager : FGModuleAbstract<FGRemoteConfigManager, FGModuleCallbacks, FGRemoteConfigSettings>
    {
        public override FGRemoteConfigSettings Settings => FGRemoteConfigSettings.settings;
        protected override FGModule Parent => FGCore.Instance;
        protected override string EventName => "RemoteConfig";
        ...
        public void AddDefaultValue(string key, object value)
        {
            ...
            {
                LogWarning("Default value already added to the dictionary: " + key);
                return;
            }
